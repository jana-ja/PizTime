...
object DummyData {
    ...
    val DummySteps = listOf(
            ...
            PizStepWithIngredients("Erstmal den Poolish machen mit gleichen Teilen Mehl und Wasser.", listOf(
                PizIngredient("Mehl", 35.0),
                PizIngredient("Wasser", 35.0)
            )
        ),
        
            PizStepWithIngredients("Hier ist jetzt ein erfundener Schritt mit einem längeren Text und vielen Zutaten." +
                ...
                PizIngredient("Zutat mit einem langen Namen der ist so lang dass der Hoffentlich nicht in eine Reihe passt und abgeschnitten wird.", 24.0),
                PizIngredient("Zutat 1", 24.0),
    ...
    val DummyPizRecipeWithDetails = PizRecipeWithDetails("Pizza Neapel", "Fluffiger Rand", R.drawable.bsp_piz, DummyIngredients, DummySteps, id = 1 )
